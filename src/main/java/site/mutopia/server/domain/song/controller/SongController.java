...
public class SongController {
    ...
    @GetMapping("/search")
    public ResponseEntity<List<SongSearchResDto>> search(@RequestParam("keyword") String keyword, @RequestParam("offset") int offset) {
    ...
    public ResponseEntity<SongInfoDto> getSong(@LoginUser(require = false) UserEntity user, @PathVariable("songId") String songId) {
